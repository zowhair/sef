                ...
                <x-main-center.main-center-left name="Educational Framework" >
                    ...
                    <x-slot name="maincontent">
                        <div  class="main-content-div">
                            <h3></h3>
                            <p> The concept of Public Private Partnership
                                (PPP) has emerged as a response and a
                                means to enhance the educational
                                system’s impact, outreach, and most
                                importantly, its institutional and
                                educational quality. In this regard, the
                                technical expertise and extensive
                                resources possessed by the private
                                sector makes it ideally positioned to
