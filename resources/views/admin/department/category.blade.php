        ...
        <div class="container bg-white">
            <div class="row">
                <div class="col-lg-12">
                    <div class="d-flex flex-wrap flex-wrap align-items-center justify-content-between mb-4">
                        <div>
                            <h4 class="mb-3">Add Department Categories</h4>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <!-- <div class="d-flex flex-wrap flex-wrap align-items-center justify-content-between mb-4"> -->
                    <form action="{{url('/department-category/add')}}" method="POST" enctype="multipart/form-data">
            ...
            @include('includes.department_category_datatable')
