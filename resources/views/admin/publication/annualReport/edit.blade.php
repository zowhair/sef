        ...
        <div class="container bg-white">
            <div class="row">
                <div class="col-lg-12">
                    <div class="d-flex flex-wrap flex-wrap align-items-center justify-content-between mb-4">
                        <div>
                            <h4 class="mb-3">Update Annual Report</h4>
                        </div>
                        <a href="/annual-report/" class="btn btn-primary add-list"><i
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <!-- <div class="d-flex flex-wrap flex-wrap align-items-center justify-content-between mb-4"> -->
                    <form action="{{url('/annual-report/update')}}" method="POST" enctype="multipart/form-data">
