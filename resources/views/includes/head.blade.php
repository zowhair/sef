    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('datatable/dataTables.bootstrap5.min.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/coppy/blog.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('css/coppy/master.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('owl/owl.carousel.css') }}">
